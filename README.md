...
## Our Goal 🎯
  ...
  Our goal is based on our detection on bad emotion on a specific keyword for improving the efficiency of Humanitarian Logistics. for example: village *XYZ* being badly damaged and the resident need food and water from Yagi storms, so based on that we could send a trucks contain food and medical supply to exactly that village right away.
